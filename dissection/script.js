...
request.onload = function() {
    if (request.status >= 200 && request.status < 400) {
        ...
        const combatants = ['pathkit','martinez_cgal', 'martinez_cpp', 'milevski', 'voidqk', 'rust-geo-booleanop', 'jscad']
...
var CreateContext = function() {
    ...
    this.combatants = ['pathkit','martinez_cgal', 'martinez_cpp', 'milevski', 'voidqk', 'rust-geo-booleanop', 'jscad']
